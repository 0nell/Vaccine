...
public class UserController {
   ...
   /* @RequestMapping({"/logout"})
    ...
    //neither
    @PostMapping({"/signup"})
    public void signup_submit(User user, HttpServletResponse response, Authentication authentication, BindingResult bindingResult) throws IOException, ParseException {
        String redirect = "/";
